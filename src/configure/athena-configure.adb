...
package body Athena.Configure is
   ...
   is
      ...
      type Generated_Star_Record is
         record
            X, Y      : Real;
            Reference : Athena.Db.Star_Reference;
      ...
      for I in 1 .. Star_Count loop
         ...
         declare
            Gen          : constant Generated_Star_Record :=
                             Vector.Element (I);
            Star_Id      : constant Athena.Identifiers.Object_Identifier :=
            ...
            Habitability : constant Unit_Real :=
                             Athena.Random.Unit_Random;
            Star_Ref   : constant Athena.Db.Star_Reference :=
                             Athena.Db.Star.Create
                               (Identifier    => Star_Id,
                                X             => Gen.X,
                                Y             => Gen.Y,
                                Core_Distance =>
      ...
      for I in 1 .. Star_Count loop
         ...
         begin
            for Nearest of Vector.Element (I).Nearest loop
               ...
               Athena.Db.Star_Distance.Create
